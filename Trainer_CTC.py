import argparse
from Src.Training.Trainer_CTC import Trainer
...
if __name__ == "__main__":
    ...
    data_dir = "/home/hpc/v123be/v123be34/UTN-CV25-Captcha-Dataset/part2/train"
    ...
    # Train the model
    trainer.train(epochs=10, save_every=2,resume_from="./checkpoints/best_model.pth")